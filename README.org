...
- [[#general-define-key-details][~general-define-key~ Details]]
  ...
  - [[#keyword-arguments][Keyword Arguments]]
    ...
    - [[#mass-key-unbinding][Mass Key Unbinding]]
...
*** Mass Key Unbinding
~general-define-key~ also provides an =:unbind= keyword. When =:unbind t= is specified, the positional arguments should all be keys (instead of pairs of keys and definitions) that should be unbound:
#+begin_src emacs-lisp
(general-define-key
 :unbind t
 :keymaps 'insert
...
It could also be used, for example, if you wanted to disable certain commands or keys from working in certain modes (example use case taken from [[https://github.com/emacs-evil/evil-collection/blob/9fc1a19807dfcd0cc2b221832b6e6faad80a291d/evil-collection-util.el#L32][evil-collection]]):
#+begin_src emacs-lisp
(general-define-key
 :unbind 'ignore
 :states 'normal
