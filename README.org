...
#+begin_src emacs-lisp
;; `general-keybindings' - an alist of keymaps to state alist
((keymap-name . state-alist) ...)
;; `general-describe-keymap-sort-function' is passed a single keymap cons
(keymap-name . state-alist)
;; a state alist (state name is nil if there is no state)
((state-name . keybindings) ...)
;; `general-describe-state-sort-function' is passed a single state cons
(state-name . keybindings)
;; `general-describe-keybinding-sort-function' is passed a single mapping
